...
## Traditional animal-based toxicicty/risk assessment<br>faces two major hurdles. 

---

## First, throughput of animal testing can't cope with the<br>>350 000 chemicals and mixtures registered for use 
...
## The majority of chemicals in use satisfy some elements of "drug-likeness" indicating they may be bioavailables
...
## Animal testing fails to elucidate *molecular* mechanisms of toxicity which are critical to develop AOPs
...
## Seemingly minute differences in protein structure can account for large disparatiresi in interspecies toxicity 
...
## Orders of DBP cytoxicity is I > Br >> Cl,<br>but only HAMS induce Nrf2 oxidatiative stress

- fix this slide

.hide-bg[
  .center[
    ![:scale 75%](images/03-DBP/assays.png)
  ]   
]
---

## To identify the targets of mHAAs and mHAMS, I developed an approach based on activity-based protein profiling
