...
# FSPE enrichement enabled the identification of over 107 proteins modified by 8:2 FTAC
...
# 8:2 FTAC only modifies GAPDH Cys247 and <br>not the catalytic Cys152 residue 
...
# Long-chain PFAS adducts promote protein aggregation in<br>*in vitro* crude cell lysate
...
# *Project 3*: Toxicoproteomics Atlas of Per- and Polyfluoroalkyl Substances in Early-Life Stages Zebrafish (*Danio rerio*)
...
# Recall that the number of IDed proteins is proportional to IDed peptides, which is dependent on LC-MS acquisition
...
## 74 PFAS exposures at two concentrations
...
--
#↓
## Relative quantfication of .my-bold[1969 proteins] across all exposures
