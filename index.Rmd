...
# Disinfection byproduct toxicity purportedly results from their reactivity towards, potentially critical, cystein residues 
...
# Long-chain PFAS adducts promote protein<br>aggregation in *in vitro* crude cell lysate
...
- .my-bold[Project 3] analyzed the proteome responses of 74 PFAS to crease the largest toxicoproteomics dataset to date
]
